...
Route::get('/projects/pendings', [ProjectController::class, 'getsom'])->middleware('auth');
...
Route::get('/investments/pendingss', [InvestmentController::class, 'getsome'])->middleware('auth');
Route::get('pendingss', function(){
    return view('pendingss');
});
